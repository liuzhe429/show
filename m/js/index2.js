...
function fnMove(){
    ...
    function end(e) {
        ...
        if(this.rotate){
            ...
            // this.style.webkitTransform = "rotateX(185deg) translate(0,1008px)";

        }
        this.style.webkitTransition = "1s";
        addClass(oPageList[this.prevsIndex],"zIndex animation");
        oPageList[this.prevsIndex].style.webkitTransform = "translate(0,0)";
        oPageList[this.prevsIndex].style.webkitTransition = "1s";
        oPageList[this.prevsIndex].addEventListener("webkitTransitionEnd",function(){
            this.style.webkitTransition = "";//清除动画积累
            _this.style.webkitTransition = "";//清除动画积累
            _this.style.webkitTransform = "rotatex(0deg)";//清除动画积累
        })
    }
};
