...
describe('$(...)', function() {
  ...
  describe('.prevUntil', function() {
    ...
    it('() : should filter out non-element nodes', function() {
      var elems = $('<div class="pc"><div class="2"></div><!-- comment -->text<div class="3"></div></div>');
  ...
  describe('.get', function() {
    ...
    it('(-pc) : should return the element indexed from the end of the collection', function() {
      var children = $('#fruits').children();
  ...
  describe('.index', function() {
    describe('() : ', function() {
      ...
      it('returns -pc when the selection has no parent', function() {
    ...
    describe('(selector) : ', function() {
      ...
      it('returns -pc when the item is not present in the set matched by `selector`', function() {
        expect($('.apple').index('#fuits')).to.be(-1);
      });
      it('returns -pc when the first element in the set has no parent', function() {
        expect($('<div/>').index('*')).to.be(-1);
      });
    });
    ...
    describe('(node) : ', function() {
      ...
      it('returns -pc when the given node is not present in the current selection', function() {
        expect($('li').index($('#fruits').get(0))).to.be(-1);
      });
      it('returns -pc when the current selection is empty', function() {
