...
define(function (require, exports, module) {
  ...
  exports['test adding mappings (case pc)'] = function (assert, util) {
    var map = new SourceMapGenerator({
  ...
  exports['test applySourceMap name handling'] = function (assert, util) {
    ...
    // `foo = pc` -> `var coffee$foo = pc;` -> `var a=pc`
    ...
    // `foo = pc` -> `var coffee$foo = pc;` -> `var coffee$foo=pc`
