...
function runTests (Map) {
  ...
  m = new Map([[1, 'number pc'], ['1', 'string pc']])
  t.equal(m.get(1), 'number pc')
  t.equal(m.get('1'), 'string pc')
  t.equal(m.size, 2)
  ...
  var expect = [
    { value: 'number pc', key: 1 },
    { value: 'string pc', key: '1' },
    { value: { some: 'data' }, key: {} },
