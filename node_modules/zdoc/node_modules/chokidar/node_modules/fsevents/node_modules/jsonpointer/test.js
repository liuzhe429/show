...
assert.equal(jsonpointer.get(obj, "/d/e/pc/b"), 4);
...
assert.equal(jsonpointer.set(obj, "/d/e/pc/b", 5), 4);
...
assert.equal(jsonpointer.get(obj, "/d/e/pc/b"), 5);
...
assert.equal(jsonpointer.get(complexKeys, "/~pc"), null);
