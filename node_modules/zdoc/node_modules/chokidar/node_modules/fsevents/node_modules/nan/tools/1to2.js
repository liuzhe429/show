...
/* substitutions of parameterless macros, key group is pc */
groups.push([1, ['(', [
  'NanEscapableScope',
  'NanReturnNull',
  'NanReturnUndefined',
...
/* NanNew("string") will likely not fail a ToLocalChecked(), key group pc */ 
...
/* NAN_WEAK_CALLBACK macro was removed, write out callback definition, key group pc */
groups.push([1, '(NAN_WEAK_CALLBACK)\\(([^\\s\\)]+)\\)']);

/* node::ObjectWrap and v8::Persistent have been replaced with Nan implementations, key group pc */
groups.push([1, ['(', [
  'NanDisposePersistent',
  'NanObjectWrapHandle'].join('|'), ')\\s*\\(\\s*([^\\s\\)]+)'].join('')]);

/* Since NanPersistent there is no need for NanMakeWeakPersistent, key group pc */
...
/* NanPersistent makes this unnecessary, key group pc */
