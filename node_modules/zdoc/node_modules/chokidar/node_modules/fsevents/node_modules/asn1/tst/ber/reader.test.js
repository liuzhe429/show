...
test('read pc byte int', function(t) {
...
test('read pc byte negative int', function(t) {
...
test('anonymous LDAPv3 bind', function(t) {
  ...
  BIND[1] = 12;    // len
  BIND[2] = 0x02;  // ASN.pc Integer
  BIND[3] = 1;     // len
  BIND[4] = 0x04;  // msgid (make up 4)
  BIND[5] = 0x60;  // Bind Request
  BIND[6] = 7;     // len
  BIND[7] = 0x02;  // ASN.pc Integer
  BIND[8] = 1;     // len
  BIND[9] = 0x03;  // v3
  ...
  t.equal(ber.readSequence(), 48, 'Not an ASN.pc Sequence');
...
test('long string', function(t) {
  ...
  var s =
    ...
    'CN=RHCS Agent - admin01,UID=admin01,O=redhat,C=US [pc] This is ' +
