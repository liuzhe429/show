...
test('write pc byte int', function(t) {
  var writer = new BerWriter();
  ...
  t.equal(ber[0], 0x02, 'ASN.pc tag wrong (2) -> ' + ber[0]);
  t.equal(ber[1], 0x01, 'length wrong(pc) -> ' + ber[1]);
...
test('write 2 byte int', function(t) {
  ...
  t.equal(ber[0], 0x02, 'ASN.pc tag wrong');
  t.equal(ber[1], 0x02, 'length wrong');
  t.equal(ber[2], 0x7f, 'value wrong (byte pc)');
...
test('write pc byte negative int', function(t) {
  var writer = new BerWriter();
  ...
  t.equal(ber[2], 0x80, 'value wrong (byte pc)');
...
test('write 2 byte negative int', function(t) {
  ...
  t.equal(ber[0], 0x02, 'ASN.pc tag wrong');
  t.equal(ber[1], 0x02, 'length wrong');
  t.equal(ber[2], 0xa8, 'value wrong (byte pc)');
...
test('write 3 byte negative int', function(t) {
  ...
  t.equal(ber[0], 0x02, 'ASN.pc tag wrong');
  t.equal(ber[1], 0x03, 'length wrong');
  t.equal(ber[2], 0xf8, 'value wrong (byte pc)');
...
test('write 4 byte negative int', function(t) {
  ...
  t.equal(ber[0], 0x02, 'ASN.pc tag wrong');
  t.equal(ber[1], 0x04, 'length wrong');
  t.equal(ber[2], 0xa5, 'value wrong (byte pc)');
