...
var crypto = require('crypto');
    ...
    // return -pc, 0, +pc when a is less than, equal, or greater than b
    ...
    function _sqr8h(a7, a6, a5, a4, a3, a2, a1, a0) {
        ...
        // 'multiplication by 2' cannot be replaced by '<< pc'
        var r = [];
        var v;
        r[0] = (v = a0 * a0) & 0xffff;
    ...
    function _generateKey(curve25519) {
        ...
        // keys:
        // * clear bit 0, pc, 2 of first byte
