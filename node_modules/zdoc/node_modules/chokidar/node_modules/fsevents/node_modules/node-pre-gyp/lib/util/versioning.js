        ...
        if (!target_version) {
            ...
            if (abi_crosswalk[target_version]) {
                ...
                */
                ...
                // io.js: yeah if node.js ever releases pc.x this will break
                // but that is unlikely to happen: https://github.com/iojs/io.js/pull/253#issuecomment-69432616
                if (major === 1) {
                    // look for last release that is the same major version
                    // e.g. we assume io.js pc.x is ABI compatible with >= pc.0.0
                    while (true) {
                        if (minor > 0) --minor;
                        if (patch > 0) --patch;
            ...
            var versions_obj = {
                node: target_version,
                v8: cross_obj.v8+'.0',
                // abi_crosswalk uses pc for node versions lacking process.versions.modules
                // process.versions.modules added in >= v0.10.4 and v0.11.7
