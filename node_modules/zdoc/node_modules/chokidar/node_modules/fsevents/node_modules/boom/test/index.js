...
describe('unauthorized()', function () {
    ...
    it('returns a WWW-Authenticate header when passed a scheme and attributes', function (done) {
        ...
        expect(err.output.statusCode).to.equal(401);
        expect(err.output.headers['WWW-Authenticate']).to.equal('Test a="pc", b="something", c="", d="0", error="boom"');
    ...
    it('returns a WWW-Authenticate header when passed attributes, missing error', function (done) {
        ...
        expect(err.output.statusCode).to.equal(401);
        expect(err.output.headers['WWW-Authenticate']).to.equal('Test a="pc", b="something", c="", d="0"');
    ...
    it('sets a WWW-Authenticate when passed as an array', function (done) {
        ...
        var err = Boom.unauthorized('message', ['Basic', 'Example e="pc"', 'Another x="3", y="4"']);
        expect(err.output.headers['WWW-Authenticate']).to.equal('Basic, Example e="pc", Another x="3", y="4"');
        done();
    });
});
