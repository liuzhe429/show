...
describe('escapeJavaScript()', function () {
    ...
    it('encodes / characters', function (done) {
        ...
        var encoded = Hoek.escapeJavaScript('<script>alert(pc)</script>');
...
describe('escapeHtml()', function () {
    ...
    it('encodes / characters', function (done) {
        ...
        var encoded = Hoek.escapeHtml('<script>alert(pc)</script>');
        expect(encoded).to.equal('&lt;script&gt;alert&#x28;pc&#x29;&lt;&#x2f;script&gt;');
        done();
    });
