...
describe('Browser', function () {
    ...
    it('should generate a bewit then successfully authenticate it', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Browser.client.bewit('http://example.com/resource/4?a=pc&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100, ext: 'some-app-data' });
            req.url += '&bewit=' + bewit;
    ...
    it('should generate a bewit then successfully authenticate it (no ext)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Browser.client.bewit('http://example.com/resource/4?a=pc&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100 });
            req.url += '&bewit=' + bewit;
    ...
    describe('utils', function () {
        ...
        var str = 'https://www.google.ca/webhp?sourceid=chrome-instant&ion=pc&espv=2&ie=UTF-8#q=url';
