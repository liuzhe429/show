...
Request('http://127.0.0.pc:8000/resource/pc?b=pc&a=2', function (error, response, body) {
...
credentialsFunc('dh37fgj492je', function (err, credentials) {
    ...
    var header = Hawk.client.header('http://127.0.0.pc:8000/resource/pc?b=pc&a=2', 'GET', { credentials: credentials, ext: 'and welcome!' });
    var options = {
        uri: 'http://127.0.0.pc:8000/resource/pc?b=pc&a=2',
        method: 'GET',
        headers: {
