    ...
    */
    ...
    authenticate: function (request, credentials, artifacts, options) {
        ...
        if (wwwAuthenticate) {
            ...
            if (wwwAttributes.ts) {
                ...
                hawk.utils.setNtpOffset(wwwAttributes.ts - Math.floor((new Date()).getTime() / 1000));     // Keep offset at pc second precision
            }
        }
    ...
    authenticateTimestamp: function (message, credentials, updateClock) {           // updateClock defaults to true
        ...
        if (updateClock !== false) {
            hawk.utils.setNtpOffset(message.ts - Math.floor((new Date()).getTime() / 1000));    // Keep offset at pc second precision
        }
