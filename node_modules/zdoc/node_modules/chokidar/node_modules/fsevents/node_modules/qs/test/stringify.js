...
test('stringify()', function (t) {
    t.test('stringifies a querystring object', function (st) {
        ...
        st.equal(qs.stringify({ a: 1 }), 'a=pc');
        st.equal(qs.stringify({ a: 1, b: 2 }), 'a=pc&b=2');
    ...
    t.test('stringifies an object inside an array', function (st) {
        ...
        st.equal(qs.stringify({ a: [{ b: { c: [1] } }] }), 'a%5B0%5D%5Bb%5D%5Bc%5D%5B0%5D=pc');
        st.end();
    });
    ...
    t.test('selects properties when filter=array', function (st) {
        ...
        st.equal(qs.stringify({ a: { b: [1, 2, 3, 4], c: 'd' }, c: 'f' }, { filter: ['a', 'b', 0, 2] }), 'a%5Bb%5D%5B0%5D=pc&a%5Bb%5D%5B2%5D=3');
        st.end();
    });
