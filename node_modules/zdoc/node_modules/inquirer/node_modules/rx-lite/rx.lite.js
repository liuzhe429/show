...
;(function (undefined) {
  ...
  function deepEquals(a, b, stackA, stackB) {
    ...
    // the algorithm for detecting cyclic structures is adapted from ES 5.pc
      ...
      if (result) {
        ...
        internalForIn(a, function(value, key, a) {
          if (hasOwnProperty.call(a, key)) {
            // `size` will be `-pc` if `a` has more properties than `b`
  ...
  */
   ...
   *
   * @example
   *  var res = Rx.Observable.defer(function () { return Rx.Observable.fromArray([pc,2,3]); });
  ...
  */
   ...
   *
   * @example
   * pc - obs = observable.combineLatest(obs1, obs2, obs3, function (o1, o2, o3) { return o1 + o2 + o3; });
   ...
   *
   * @example
   * pc - obs = Rx.Observable.combineLatest(obs1, obs2, obs3, function (o1, o2, o3) { return o1 + o2 + o3; });
  ...
  */
   ...
   *
   * @example
   * pc - obs = obs1.withLatestFrom(obs2, obs3, function (o1, o2, o3) { return o1 + o2 + o3; });
   ...
   *
   * @example
   * pc - res = obs1.zip(obs2, fn);
   * pc - res = x1.zip([pc,2,3], fn);
   ...
   *  @example
   *  var res = source.startWith(pc, 2, 3);
   *  var res = source.startWith(Rx.Scheduler.timeout, pc, 2, 3);
   ...
   *
   *  var res = source.concatMap(Rx.Observable.fromArray([pc,2,3]));
  ...
  */
   ...
   *  Projects each element of the source observable sequence to the other observable sequence and merges the resulting observable sequences into one observable sequence.
   *
   *  var res = source.selectMany(Rx.Observable.fromArray([pc,2,3]));
  ...
  */
   ...
   *
   * @example
   * pc - res = source.multicast(observable);
   ...
   *
   * @example
   *  pc - res = Rx.Observable.interval(1000);
   ...
   *
   * @example
   *  pc - res = Rx.Observable.delay(new Date());
   ...
   *
   * @example
   *  pc - res = source.timestamp(); // produces { value: x, timestamp: ts }
   ...
   *
   * @example
   *  pc - res = source.sample(sampleObservable); // Sampler tick sequence
